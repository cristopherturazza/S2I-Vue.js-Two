<template>
  <div class="flex flex-col">
    <div class="my-6 ml-8 mr-12 text-stone-800">
        ...
        >
          <div class="flex flex-row">
            ...
            <div class="flex flex-col ml-4">
              <span class="font-semibold text-sm my-2"> {{ cartEntry.name }}</span>
              <div
                class="quantity-selector flex flex-row rounded-xl items-center font-semibold bg-stone-200 border border-stone-300"
              >
                <div
